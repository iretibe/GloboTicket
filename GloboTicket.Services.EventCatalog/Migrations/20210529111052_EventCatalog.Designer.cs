...
namespace GloboTicket.Services.EventCatalog.Migrations
{
    ...
    [Migration("20210529111052_EventCatalog")]
    partial class EventCatalog
    {
            ...
            modelBuilder.Entity("GloboTicket.Services.EventCatalog.Entities.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Artist = "John Egbert",
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            Date = new DateTime(2021, 11, 29, 11, 10, 49, 159, DateTimeKind.Local).AddTicks(796),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            Date = new DateTime(2022, 2, 28, 11, 10, 49, 164, DateTimeKind.Local).AddTicks(367),
                        ...
                        new
                        {
                            ...
                            Artist = "DJ 'The Mike'",
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            Date = new DateTime(2021, 9, 29, 11, 10, 49, 164, DateTimeKind.Local).AddTicks(1054),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            Date = new DateTime(2021, 9, 29, 11, 10, 49, 164, DateTimeKind.Local).AddTicks(1249),
                        ...
                        new
                        {
                            ...
                            Artist = "Many",
                            CategoryId = new Guid("fe98f549-e790-4e9f-aa16-18c2292a2ee9"),
                            Date = new DateTime(2022, 3, 29, 11, 10, 49, 164, DateTimeKind.Local).AddTicks(1419),
                        ...
                        new
                        {
                            ...
                            Artist = "Nick Sailor",
                            CategoryId = new Guid("6313179f-7837-473a-a4d5-a5571b43e6a6"),
                            Date = new DateTime(2022, 1, 29, 11, 10, 49, 164, DateTimeKind.Local).AddTicks(1598),
