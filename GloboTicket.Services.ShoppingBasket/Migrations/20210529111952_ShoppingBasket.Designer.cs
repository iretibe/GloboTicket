...
namespace GloboTicket.Services.ShoppingBasket.Migrations
{
    ...
    [Migration("20210529111952_ShoppingBasket")]
            ...
            modelBuilder.Entity("GloboTicket.Services.ShoppingBasket.Entities.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Date = new DateTime(2021, 11, 29, 11, 19, 49, 386, DateTimeKind.Local).AddTicks(2691),
                            Name = "John Egbert Live"
                        },
                        new
                        {
                            EventId = new Guid("3448d5a4-0f72-4dd7-bf15-c14a46b26c00"),
                            Date = new DateTime(2022, 2, 28, 11, 19, 49, 390, DateTimeKind.Local).AddTicks(8068),
                            Name = "The State of Affairs: Michael Live!"
                        },
                        new
                        {
                            EventId = new Guid("b419a7ca-3321-4f38-be8e-4d7b6a529319"),
                            Date = new DateTime(2021, 9, 29, 11, 19, 49, 390, DateTimeKind.Local).AddTicks(8235),
                            Name = "Clash of the DJs"
                        },
                        new
                        {
                            EventId = new Guid("62787623-4c52-43fe-b0c9-b7044fb5929b"),
                            Date = new DateTime(2021, 9, 29, 11, 19, 49, 390, DateTimeKind.Local).AddTicks(8259),
                            Name = "Spanish guitar hits with Manuel"
                        },
                        new
                        {
                            EventId = new Guid("1babd057-e980-4cb3-9cd2-7fdd9e525668"),
                            Date = new DateTime(2022, 3, 29, 11, 19, 49, 390, DateTimeKind.Local).AddTicks(8270),
                            Name = "Techorama 2021"
                        },
                        new
                        {
                            EventId = new Guid("adc42c09-08c1-4d2c-9f96-2d15bb1af299"),
                            Date = new DateTime(2022, 1, 29, 11, 19, 49, 390, DateTimeKind.Local).AddTicks(8281),
